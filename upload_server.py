import os
import mimetypes
from flask import Flask, request, redirect, url_for, Response, Request
...
def download_file(filename):
    print filename
    if filename and request.method == 'GET':
        ...
        if 'Range' in request.headers:
            ...
            response = Response(data[start:end], mimetype=mimeType, status=206)
